...
public class AUTCadastroCliente extends AUTVABaseComponent{
	...
	public boolean autCadastroClienteMultiplosTelefonesVA(java.util.HashMap parametros) {
...
//			AUT_AGENT_SILK4J.<DomTextField>find("VA.CadastroClientesDados.NumeroTelefone").domClick();
			...
			AUT_AGENT_SILK4J.<DomButton>find("VA.CadastroClientesDados.AdicionarNovoTelefone").click();

			//---- Telefone 2 --------
			
			AUT_AGENT_SILK4J.<DomListBox>find("VA.CadastroClientesDados.TipoTelefone2").click();
			AUT_AGENT_SILK4J.<DomListBox>find("VA.CadastroClientesDados.TipoTelefone2").select(tipoTelefone2);
