...
public class AUTFluxoSaida extends AUTVABaseComponent{
	...
	public boolean autVaFluxoSaida(AUT_VA_FLUXO_SAIDA fluxoSaida) {
		...
		try {
			...
			else if(fluxoSaida == AUT_VA_FLUXO_SAIDA.RETIRA_EXTERNA_AGENDADA) {
