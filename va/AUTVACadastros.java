...
public class AUTVACadastros extends AUTVALogin {
	...
	public enum AUT_VA_TIPO_RESIDENCIA{
		...
		public String toString() {
			...
			case CONDOMINIO:{
				return "SALA_OU_CONJUNTO_COMERCIAL";
			}
			case DEPOSITO_OU_GALPAO:{
				return "DEPOSITO_OU_GALPAO";
			}
			case LOJA_OU_SOBRELOJA:{
				return "LOJA_OU_SOBRELOJA";
			}
			case OUTROS:{
				return "OUTROS";
			}
			case RURAL_CHACARA_FAZENDA_OU_SITIO:{
				return "RURAL_CHACARA_FAZENDA_SITIO";
			}
			case SALA_OU_CONJUNTO_COMERCIAL:{
				return "SALA_OU_CONJUNTO_COMERCIAL";
			}
			case TERRENO_OU_LOTEAMENTO:{
				return "TERRENO_OU_LOTEAMENTO";
			}
			}
			return super.toString();
		}
	...
	public void autInitClientMenu() {
		...
		String ClienteInscricao = autGetDataFlow().AUT_GLOBAL_PARAMETERS.get(AUT_TABLE_PARAMETERS_NAMES.AUT_VA_CADASTRO_PF.toString()).get(1).get("AUT_INCRICAO_ESTADUAL").toString();
		...
		String tipoTelefone = autGetDataFlow().AUT_GLOBAL_PARAMETERS.get(AUT_TABLE_PARAMETERS_NAMES.AUT_VA_CADASTRO_PF.toString()).get(1).get("AUT_TIPO_TELEFONE").toString();
		...
		String bairroResidencia = autGetDataFlow().AUT_GLOBAL_PARAMETERS.get(AUT_TABLE_PARAMETERS_NAMES.AUT_VA_CADASTRO_PF.toString()).get(1).get("AUT_BAIRRO_ENDERECO").toString();
		...
		txtComplementoResidEnd.setText(tipoImovelResidencia);
